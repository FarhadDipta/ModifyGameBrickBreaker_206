...
class Paddle(GameObject):
    def __init__(self, canvas, x, y):
        ...
        item = canvas.create_rectangle(x - self.width / 2,
                                       ...
                                       x + self.width / 2,
                                       y + self.height / 2,
                                       fill='#FFB643', outline="red", width=2)
...
class Brick(GameObject):
    COLORS = {1: '#FF6F61', 2: '#FFA07A', 3: '#8FE1A2'}
    ...
    def __init__(self, canvas, x, y, hits):
        ...
        item = canvas.create_rectangle(x - self.width / 2,
                                       ...
                                       x + self.width / 2,
                                       y + self.height / 2,
                                       fill=color, tags='brick', outline="black")
...
class Game(tk.Frame):
    ...
    def game_loop(self):
        ...
        if num_bricks == 0:
            self.draw_text(300, 200, 'You Win!', 30)
        elif self.ball.get_position()[3] >= self.height:
            self.lives -= 1
            if self.lives < 0:
                self.draw_text(300, 200, 'Game Over', 30)
            else:
